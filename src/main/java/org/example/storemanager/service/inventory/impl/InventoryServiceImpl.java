...
import org.example.storemanager.dto.response.catalog.inventory.InventorySummaryProjection;
import org.example.storemanager.dto.response.catalog.inventory.StockLedgerResponse;
import org.example.storemanager.dto.response.common.PageResponse;
import org.example.storemanager.dto.inventory.*;
...
import org.example.storemanager.entity.inventory.*;
...
import org.example.storemanager.enums.inventory.*;
...
import org.example.storemanager.repository.inventory.*;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    private final org.example.storemanager.repository.wms.ProductLocationRepository productLocationRepository;
    private final org.example.storemanager.repository.inventory.InventoryBalanceRepository inventoryBalanceRepository;
    private final org.example.storemanager.repository.inventory.InventoryTransactionRepository inventoryTransactionRepository;
    private final org.example.storemanager.repository.catalog.SerialNumberRepository serialNumberRepository;
    ...
    public ImportReceiptDTO submitImportReceipt(Long id) {
        ...
        if (!"DRAFT".equals(r.getStatus()) && !"PENDING".equals(r.getStatus())) {
            throw new org.example.storemanager.exception.BusinessException(
                org.example.storemanager.enums.ErrorCode.INVALID_STATUS_TRANSITION,
    ...
    public ReturnToSupplierDTO createReturnToSupplier(ReturnToSupplierDTO dto) {
        ...
        ReturnToSupplier r = ReturnToSupplier.builder()
                ...
                .status(org.example.storemanager.enums.inventory.ReturnToSupplierStatus.PENDING_SUPPLIER_APPROVAL)
    ...
    @Override
    @Transactional
    public ReturnToSupplierDTO approveReturnToSupplier(Long id, org.example.storemanager.dto.request.catalog.inventory.ReturnApprovalRequest request) {
        ReturnToSupplier r = returnToSupplierRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new ResourceNotFoundException("ReturnToSupplier", "id", id));
        if (r.getStatus() == org.example.storemanager.enums.inventory.ReturnToSupplierStatus.APPROVED_CREDIT_NOTE) {
            return toReturnToSupplierDTO(r);
        }

        r.setStatus(org.example.storemanager.enums.inventory.ReturnToSupplierStatus.APPROVED_CREDIT_NOTE);
    ...
    @Override
    @Transactional
    public ReturnToSupplierDTO rejectReturnToSupplier(Long id, org.example.storemanager.dto.request.catalog.inventory.ReturnRejectRequest request) {
        ReturnToSupplier r = returnToSupplierRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new ResourceNotFoundException("ReturnToSupplier", "id", id));
        r.setStatus(org.example.storemanager.enums.inventory.ReturnToSupplierStatus.REJECTED);
    ...
    public CancelIssueDTO createCancelIssue(CancelIssueDTO dto) {
        ...
        CancelIssue c = CancelIssue.builder()
                ...
                .reason(dto.getReason())
                .status(org.example.storemanager.enums.inventory.CancelIssueStatus.PENDING_APPROVAL)
                .branch(branch)
                .build();
    ...
    @Override
    @Transactional
    public ImportReceiptDTO cancelImportReceipt(Long id, org.example.storemanager.dto.request.catalog.inventory.ImportCancelRequest request) {
        ImportReceipt r = importReceiptRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new ResourceNotFoundException("ImportReceipt", "id", id));
        if ("COMPLETE".equals(r.getStatus())) {
            throw new org.example.storemanager.exception.inventory.InvalidStatusTransitionException(r.getStatus(), "CANCELLED");
        }
    ...
    @Override
    @Transactional
    public CancelIssueDTO approveCancelIssue(Long id, org.example.storemanager.dto.request.catalog.inventory.CancelIssueApprovalRequest request) {
        CancelIssue c = cancelIssueRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new ResourceNotFoundException("CancelIssue", "id", id));
        if (org.example.storemanager.enums.inventory.CancelIssueStatus.APPROVED.equals(c.getStatus())) {
            return toCancelIssueDTO(c);
        }
        c.setStatus(org.example.storemanager.enums.inventory.CancelIssueStatus.APPROVED);
        if (request != null && request.getApprovalNotes() != null) {
    ...
    @Override
    @Transactional
    public CancelIssueDTO rejectCancelIssue(Long id, org.example.storemanager.dto.request.catalog.inventory.CancelIssueRejectRequest request) {
        CancelIssue c = cancelIssueRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new ResourceNotFoundException("CancelIssue", "id", id));
        c.setStatus(org.example.storemanager.enums.inventory.CancelIssueStatus.REJECTED);
        if (request != null && request.getRejectNotes() != null) {
    ...
    @Override
    @Transactional
    public StockTransferDTO completeStockTransfer(Long id, org.example.storemanager.dto.request.catalog.inventory.TransferCompleteRequest request) {
        StockTransfer t = stockTransferRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new ResourceNotFoundException("StockTransfer", "id", id));
    ...
    @Override
    @Transactional
    public StockTransferDTO cancelStockTransfer(Long id, org.example.storemanager.dto.request.catalog.inventory.TransferCancelRequest request) {
        StockTransfer t = stockTransferRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new ResourceNotFoundException("StockTransfer", "id", id));
        if ("COMPLETED".equals(t.getStatus())) {
            throw new org.example.storemanager.exception.inventory.InvalidStatusTransitionException(t.getStatus(), "CANCELLED");
        }
    ...
    @Override
    @Transactional
    public ProductBatchDTO adjustProductBatch(Long id, org.example.storemanager.dto.request.catalog.inventory.BatchAdjustRequest request) {
        ProductBatch b = productBatchRepository.findByIdAndIsDeletedFalse(id)
                .orElseThrow(() -> new ResourceNotFoundException("ProductBatch", "id", id));
