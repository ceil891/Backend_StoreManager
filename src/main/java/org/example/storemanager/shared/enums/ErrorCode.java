...
public enum ErrorCode {
    ...
    INVENTORY_NOT_FOUND(HttpStatus.NOT_FOUND, "Không tìm thấy thông tin kho"),
    BATCH_EXPIRED(HttpStatus.BAD_REQUEST, "Lô hàng đã hết hạn sử dụng"),
    DUPLICATE_CHECK(HttpStatus.CONFLICT, "Phiếu kiểm kho bị trùng lặp"),
